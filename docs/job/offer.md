...
|     | 企业       | 岗位                                               | 状态                                                                            | 日期 |
| --- | ---------- | -------------------------------------------------- | ------------------------------------------------------------------------------- | ---- |
| 1   | 网易互娱   | 游戏研发工程师                                     | 简历×（打电话叫我投递然后给我简历挂了                                           | 8.25 |
| 2   | 米哈游     | 游戏开发（音频                                     | 筛选√笔试√一面×                                                                 | 8.25 |
| 3   | 联想       | 嵌入式开发工程师                                   | 筛选×                                                                           | 8.25 |
| 4   | 小米       | 软件研发                                           | 测评√笔试√一面√二面√面试通过微信意向√谈薪挺满意的√接了签了√                     | 8.28 |
| 5   | 快手       | 客户端开发工程师                                   | 筛选×                                                                           |      |
| 6   | Garena     | 客户端开发工程师                                   | 简历×                                                                           | 8.25 |
| 7   | vivo       | 音视频（深圳，试一试音视频                         | 测评√笔试没做来太晚了岗位在深圳×                                                | 8.29 |
...
| 15  | 中兴       | 软件开发工程师                                     | 筛选√笔试√换岗面试×                                                             | 9.1  |
| 16  | 拼多多     | 服务端研发工程师                                   | 筛选√测评√笔试√面试×（先下面好难                                                | 9.1  |
| 17  | 海康       | 软件开发工程师                                     | 测评√笔试√一面√hr面√拒了                                                        |      |
| 18  | 字节       | cpp客户端                                          | 电话邀请笔试√换岗面试×（误闯天家了                                              |      |
| 19  | 小红书     | 音视频开发工程师/多媒体高性能优化工程师(C/C++方向) | ×                                                                               | 9.8  |
| 20  | 滴滴       | c++/go开发工程师                                   | 秒挂×                                                                           | 9.8  |
| 21  | oppo       | 多媒体开发工程师（C++）                            | 筛选√笔试没去×                                                                  | 9.8  |
| 22  | 恒生电子   | C/C++开发工程师(J10339)                            | 筛选√笔试√一面√二面（好恶心，                                                   | 9.8  |
| 23  | 同花顺     | C++开发工程师-核心行情系统                         | 筛选×                                                                           |      |
| 24  | 京东       | 后端开发工程师                                     | 筛选√笔试（纯泡×                                                                | 9.8  |
| 25  | 华为       | 通用软件开发（open harmony                         | 筛选√笔试√面试（不去了开摆了，又和hr约了一次想去了                              |      |
| 26  | b站        | 音视频                                             | 筛选√笔试×（笔试几乎都对给我挂了，不想要我可以直说                              |      |
| 27  | 巨人网络   | 游戏服务端客户端                                   | 筛选√笔试×                                                                      |      |
| 28  | 网易雷火   | 游戏服务端客户端                                   | 筛选√笔试√面试（放弃了，岗位不合适加上小米开完了                                |      |
...
| 41  | 阿里-盒马  | 未开                                               |                                                                                 |      |
| 42  | 招商银行   | 职能类岗位（系统研发方向）                         | 傻逼银行（至于为什么傻逼全是交通银行的线下面试                                  |      |
| 43  | 上海银行   | 总行金融科技岗位（应用开发）                       | 笔试√面试拒了                                                                   |      |
| 44  | 交通银行   | 软件开发工程师（工作地点：上海）                   | 傻逼银行                                                                        |      |
| 45  | 工商银行   | 上海分行-科技菁英                                  | 傻逼银行                                                                        |      |
